...
class AlarmIndexController: UINavigationController {
    ...
    func initItem(){
        ...
        var image = UIImage(named: "index_alarm");
//        image = CommonUtil.resizeImage(image!,scan: 0.5)
        //设置选中时的图标
        var selectedImage = UIImage(named: "index_alarm_selected");
