...
//                println(body)
    ...
    */
    ...
    :param: paged          当前页码
    */
    func OrderAlipay(successHandler:SERVICEHANDLER,errorHandler:SERVICEHANDLER,body:[String:AnyObject]){
        
        
        var url = getUrl(StatusCode.URL.F_ORDER_ALIPAY)
    ...
    :param: paged          当前页码
    */
    func OrderWXpay(successHandler:SERVICEHANDLER,errorHandler:SERVICEHANDLER,body:[String:AnyObject]){
        
        
        var url = getUrl(StatusCode.URL.F_ORDER_WXPAY)
